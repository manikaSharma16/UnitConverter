...
fun UnitConverter(){
    Column(
        ...
        fun convertUnits(){
            // ?: : elvis operator
            val inputValueDouble = inputValue.toDoubleOrNull() ?: 0.0 // If Nan in input value, then 0.0
            val result = ((inputValueDouble * conversionFactor * 100)/oConversionFactor).roundToInt() / 100
